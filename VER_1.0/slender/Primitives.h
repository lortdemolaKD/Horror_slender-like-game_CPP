...
{
public:
	Triangle3D() : Primitive()
	{
		Vertex vertices[] =
		{
			//positon                          //color                         //texcoord               //normal
			glm::vec3(-0.f, 0.5f, 0.5f),    glm::vec3(1.f, 0.f, 0.f),	glm::vec2(0.f, 1.f),	glm::vec3(0.f, 0.f, 1.f),
			glm::vec3(-0.5f, -0.5f, 0.5f),   glm::vec3(0.f, 1.f, 0.f),	glm::vec2(0.f, 0.f),	glm::vec3(0.f, 0.f, 1.f),
			glm::vec3(0.5f,-0.5f, 0.5f),		glm::vec3(0.f, 0.f, 1.f),	glm::vec2(1.f, 0.f),	glm::vec3(0.f, 0.f, 1.f),
		
			glm::vec3(0.f, 0.5f, -0.5f),    glm::vec3(1.f, 0.f, 0.f),	glm::vec2(0.f, 1.f),	glm::vec3(0.f, 0.f, 0.f),
...
class InvertCube : public Primitive
{
public:
	InvertCube() : Primitive()
	{
		Vertex vertices[] =
		{
			//positon                          //color                         //texcoord               //normal
			//triangle front
			glm::vec3(1.5f, -2.5f, -1.5f),		glm::vec3(1.f, 0.f, 0.f),	glm::vec2(0.f, 1.f),	glm::vec3(-1.f, 0.f, 1.f),
			glm::vec3(1.4f,-0.5f, -1.4f),		glm::vec3(0.f, 1.f, 0.f),	glm::vec2(0.f, 0.f),	glm::vec3(-1.f, 0.f, 1.f),
			glm::vec3(-1.4f, -0.5f, -1.4f),		glm::vec3(0.f, 0.f, 1.f),	glm::vec2(1.f, 0.f),	glm::vec3(1.f, 0.f, 1.f),
			glm::vec3(-1.5f, -2.5f, -1.5f),  	glm::vec3(1.f, 1.f, 0.f),	glm::vec2(1.f, 1.f),	glm::vec3(1.f, 0.f, 1.f),
...
public:
	Button() : Primitive()
	{
		Vertex vertices[] =
		{
			...
			glm::vec3(-0.5f, 0.5f, 0.5f),		glm::vec3(1.f, 1.f, 0.f),	glm::vec2(0.f, 0.f),	glm::vec3(0.f, 0.f,-1.f),//
